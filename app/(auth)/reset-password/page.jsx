                    ...
                    <section className="form-container">
                     ...
                     <form  className="step-container" onSubmit={handleReset} ref={formRef}>
                            ...
                            <label className=" flex items-center gap-2">
                             ...
                             <button type="submit" disabled={isLoading}> <span className={isLoading ? "loading loading-spinner loading-sm mr-2": null}></span>{isLoading ? "Loading...": "Reset Password"}</button>
                        </form>
                     </article>
