  ...
  return (
      <div className="grid lg:grid-cols-3 gap-5">
        <section className="lg:col-span-2 rounded-2xl bg-[#fff] border border-slate-200 p-6 lg:p-8 shadow-sm">
          <h2 className="font-display font-bold text-base" style={montserrat.style}>Send money</h2>
          <p className="opacity-60 text-[13px] md:text-sm">Instant peer-to-peer transfers with zero fees.</p>
