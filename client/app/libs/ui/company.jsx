       ...
       <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{duration: 0.5}} >
        ...
        <main className="hero my-[-20vh] md:my-[-12vh] min-h-screen" id="company">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <section>
                 <h1 className="text-5xl md:text-6xl leading-[1.2] font-bold"> Your <span className="text-[#05365e]">Financial</span> Future!</h1>
                <p className="py-4">
                ...
                <Link href={"/app"} className="btn bg-linear-to-tr outline-none border-none from-blue-900 from-50% to-blue-500 p-6 w-fit flex items-center pt-5 hover:scale-97 rounded-md">Get Started <span className="text-xl">»</span></Link>
                </section>
            </div>
        </main>
