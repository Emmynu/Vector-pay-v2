       ...
       <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{duration: 0.5}} >
        ...
        <main className="hero my-[-20vh] md:my-[-12vh] min-h-screen" id="company">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <Link href={"/dashboard"} className={`btn bg-linear-to-tr outline-none border-none from-blue-900 from-50% to-blue-500 p-6 w-fit flex items-center  hover:scale-97 rounded-md ${bricolage.className}`}>Get Started <span className="text-xl mt-[-2.5px]">»</span></Link>
                </section>
            </div>
        </main>
