...
import { ArrowUpRight, Wallet, Building2, ArrowDownLeft, History, Dot, ArrowRight } from "lucide-react";
  ...
  return (
    <section className="mt-6 shadow-md bg-white rounded-2xl border border-slate-200 px-5 py-8">
      <header className="flex justify-between items-center">
        ...
        <Link href={"/dashboard/transactions"} className="text-[#03457C] text-xs font-medium hover:opacity-90 flex items-center gap-0.5" style={ubuntu.style}>
