...
export default function Footer() {
    ...
    return(
        <footer className="bg-blue-50 ">  
            ...
            {cols.map((c) => (
            <div key={c.title} style={quicksand.style}>
            ...
            <div className="border-t border-blue-100 text-xs text-[#1F2024] ">
                <div className={`mx-auto max-w-7xl px-6 py-7 flex flex-col md:flex-row justify-between gap-2 ${quicksand.className} `}>
                    <span className="font-semibold">© 2026 VectorPay, Inc. All rights reserved.</span>
...
export function FooterRights() {
    return(
           <div className="border-t border-slate-300 border-border font-semibold text-sm  p-7" style={quicksand.style}>
